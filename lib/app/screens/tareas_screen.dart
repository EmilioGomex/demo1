...
class _TareasScreenState extends State<TareasScreen> {
  ...
  Icon _iconoTipoTarea(String? tipo) {
    switch (tipo?.toLowerCase()) {
      ...
      case 'inspección':
      case 'inspeccion':
        return Icon(Icons.search, color: Colors.white, size: 28);
      case 'lubricación':
      case 'lubricacion':
        return Icon(Icons.oil_barrel, color: Colors.white, size: 28);
      case 'apriete':
        return Icon(Icons.settings, color: Colors.white, size: 28);
      default:
        return Icon(Icons.task_alt, color: Colors.white, size: 28);
    }
  }
