...
for rnum, row in rows.items():
    ...
    for fc, ds in fechas:
        ...
        if not maq or no_labora(horario, codigo, maq): continue
...
for maq, t, ds, nombre, fallback in records:
    if fallback and (maq, t, ds) in explicit:
        continue
    agg[(maq, t, ds)].append(nombre)
for maq in ['Pasteurizador','Paletizadora','Despaletizadora','Encajonadora','Llenadora','Etiquetadora','Inspector de Botellas Vacias','Lavadora','Lavadora de Cajas','Desencajonadora']:
    print('MACHINE=' + maq)
    for t in ['Manana','Tarde','Noche']:
        vals = []
        for ds in ['20/4/2026','21/4/2026','22/4/2026','23/4/2026','24/4/2026','25/4/2026','26/4/2026']:
